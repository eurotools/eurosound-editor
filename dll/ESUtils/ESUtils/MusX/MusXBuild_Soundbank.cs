...
namespace ESUtils
{
    ...
    {
        //-------------------------------------------------------------------------------------------------------------------------------
        public static void BuildSoundbankFile(string sfxFilePath, string sifFilePath, string sbFilePath, string ssFilePath, string OutputFilePath, uint fileHashCode, bool bigEndian)
        {
