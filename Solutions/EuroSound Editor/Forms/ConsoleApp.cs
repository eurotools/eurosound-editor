...
namespace sb_editor.Forms
{
    ...
    public partial class ConsoleApp : Form
    {
        ...
        {
            btnDeLoadSoundBanks.Cursor = new Cursor(new MemoryStream(Properties.Resources.arrow_left));
            btnLoadSoundbanks.Cursor = new Cursor(new MemoryStream(Properties.Resources.arrow_right));
