...
namespace EuroSound_Editor.Audio_Classes
{
    ...
    public class ImaFunctions
    {
        ...
        //-------------------------------------------------------------------------------------------------------------------------------
        public byte[] DecodeStatesIma(byte[] ImaFileData, int numSamples)
        {
            using (MemoryStream statesStream = new MemoryStream())
            using (BinaryWriter outBuff = new BinaryWriter(statesStream))
            {
                ...
                /*Write first four empty bytes*/
                outBuff.Write(new byte[4]);
                ...
                for (int i = 0; i < numSamples; i++)
                {
                    ...
                    */
                    ...
                    if (i % 2 != 0)
                    {
                        outBuff.Write(EngineXState);
                    }
                }
                state.valprev = valpred;
                state.index = index;

                return statesStream.ToArray();
            }
        }
