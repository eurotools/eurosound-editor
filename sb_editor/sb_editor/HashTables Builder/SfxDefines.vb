...
Namespace HashTablesBuilder
    Friend Class SfxDefines
        '*===============================================================================================
        '* SFX_Defines.h
        '*===============================================================================================
        Public Sub CreateSfxDefines(mainForm As ExporterForm, sfxDict As SortedDictionary(Of String, UInteger), soundbanksDict As SortedDictionary(Of String, UInteger), Languages As String(), prefixHashCodes As Boolean, filePath As String)
            ...
            mainForm.Invoke(Sub() mainForm.Text = "Writing SFX_Defines.h Stage 0")
            ...
            'HASHCODES
            mainForm.Invoke(Sub() mainForm.Text = "Writing SFX_Defines.h Stage 1")
            ...
            Next
            mainForm.Invoke(Sub() mainForm.Text = "Writing SFX_Defines.h Stage 2")
        ...
        '* SFX_Debug.h
        '*===============================================================================================
        Public Sub CreateSfxDebug(mainForm As ExporterForm, sfxDict As SortedDictionary(Of String, UInteger), filePath As String)
            FileOpen(1, filePath, OpenMode.Output, OpenAccess.Write, OpenShare.LockWrite)
            'Write first part
            mainForm.Invoke(Sub() mainForm.Text = "Writing SFX_Defines.h Stage 3")
        ...
        '* SFX_Data.h
        '*===============================================================================================
        Public Sub CreateSfxData(mainForm As ExporterForm, filePath As String, folderPath As String, maxHashCode As Integer)
            ...
            'Create file
            mainForm.Invoke(Sub() mainForm.Text = "Writing SFX_Data.h")
            FileOpen(1, filePath, OpenMode.Output, OpenAccess.Write, OpenShare.LockWrite)
